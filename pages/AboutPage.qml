        ...
        Column {
            ...
            Rectangle {
                ...
                Column {
                    ...
                    Label {
                        width: parent.width
                        text: "A lean system monitor for Sailfish OS. Nothing fancy, "
                              + "just the stats you need without the bloat."
                        font.pixelSize: Theme.fontSizeSmall
            ...
            Rectangle {
                ...
                Column {
                    ...
                    Label {
                        width: parent.width
                        text: "Every line was written, tested and debugged directly "
                              + "on a Sony Xperia XA2. No desktop IDE, no emulator, "
                              + "no SDK. Just a phone, a terminal, and a lot of patience."
