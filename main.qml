...
ApplicationWindow {
    ...
    property var latestStats: ({
        ...
        "history": {"cpu": [], "ram": []},
        "system": {
            "model": "Device", "processor": "--", "kernel": "--",
            "uptime": "--", "os": "Sailfish OS", "os_version": "--",
            "arch": "--", "hostname": "--"
        }
    })
                ...
                Column {
                    ...
                    Item {
                        ...
                        Column {
                            ...
                            Label {
                                width: parent.width
                                text: app.latestStats.system.os + " " + app.latestStats.system.os_version
                                      + " · " + app.latestStats.system.kernel
                                font.pixelSize: Theme.fontSizeExtraSmall
                                color: Theme.secondaryColor
                            ...
                            Label {
                                width: parent.width
                                text: app.latestStats.system.arch + " · " + app.latestStats.system.hostname
                                      + " · Uptime: " + app.latestStats.system.uptime
                                font.pixelSize: Theme.fontSizeExtraSmall
                                color: Theme.secondaryColor
                                truncationMode: TruncationMode.Fade
                            }
                        ...
                        Column {
                            ...
                            Row {
                                ...
                                Label {
                                    ...
                                    text: (app.latestStats.cpu.cores || 0) + " cores @ "
                                          + (app.latestStats.cpu.freq || "--")
                                    font.pixelSize: Theme.fontSizeExtraSmall
                                    color: Theme.secondaryColor
                                }
                            }
                            ...
                            Canvas {
                                ...
                                onPaint: {
                                    ...
                                    var data = app.latestStats.history
                                               ? app.latestStats.history.cpu : []
                        ...
                        Column {
                            ...
                            Row {
                                ...
                                Label {
                                    ...
                                    text: (app.latestStats.ram.used || 0) + " / "
                                          + (app.latestStats.ram.total || 0) + " MB"
                                    font.pixelSize: Theme.fontSizeExtraSmall
                                    color: Theme.secondaryColor
                                }
                            }
                        ...
                        Column {
                            ...
                            Row {
                                ...
                                Label {
                                    ...
                                    text: (app.latestStats.storage.used || 0) + " / "
                                          + (app.latestStats.storage.total || 0) + " GB"
                                    font.pixelSize: Theme.fontSizeExtraSmall
                                    color: Theme.secondaryColor
                                }
                            }
                            ...
                            Row {
                                ...
                                Label {
                                    ...
                                    text: {
                                        ...
                                        var st = app.latestStats.battery.status || "Unknown"
                                        return (st === "Charging" ? "⚡ " : "") + cap + "%"
                                    }
                                    font.pixelSize: Theme.fontSizeLarge
                                    font.bold: true
                                    color: {
                    ...
                    Item {
                        ...
                        Column {
                            ...
                            Label {
                                text: (app.latestStats.network.iface || "None") + " · "
                                      + (app.latestStats.network.ip || "--")
                                font.pixelSize: Theme.fontSizeExtraSmall
                                color: Theme.secondaryColor
                                truncationMode: TruncationMode.Fade
                            }
                            ...
                            Item {
                                ...
                                Rectangle {
                                    ...
                                    width: parent.width * Math.min(
                                        (app.latestStats.thermal.cpu_temp || 0) / 100, 1)
                                    Behavior on width {
                                        SmoothedAnimation {
                                            duration: 1000
                                            easing.type: Easing.OutCubic
